...
export default function Other() {
  const { apiData } = useApi(
    `https://api.themoviedb.org/3/discover/movie?api_key=2a5ea2a3ee756b16dbbf353821dd7157&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=20`
  );
