...
export default function Tv() {
  ...
  async function getApiData() {
    const { data } = await axios.get(
      "https://api.themoviedb.org/3/discover/tv?api_key=2a5ea2a3ee756b16dbbf353821dd7157&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=100"
    );
    ...
    <>
      {apiData ? (
        <div className="container mt-5 pt-5">
          <h2 className="text-white mt-3 mb-5   text-center">TV Shows</h2>
